...
<?php
    ...
    // #region 1. Propriedades da classe do BrapiService
    private string $token ="idwc329WmXydC94WFjRK3M";
    private string $url ="https://brapi.dev/api";
    // #endregion
    ...
    public function buscarCotacao(string $tickers): array {
        $url = "{$this->url}/quote/{$tickers}?token={$this->token}";
